...
export const createListing = async (
    ...
    if (!address || !description || !price || !length || !width || !height|| !pictures|| !latitude|| !longitute|| !listing_AvailableStartInput || listing_AvailableEndInput) throw 'Error: Invalid number of parameters entered (Expected 5)'
